#ifndef GALLIUM__ASSETS__LOADERS__IMAGE_EXR_H
#define GALLIUM__ASSETS__LOADERS__IMAGE_EXR_H
#pragma once
...
namespace ga::assets::loaders
{
    ...
    public:
        explicit ExrImageLoader(gpu::Device& gpu);
...
#endif /* GALLIUM__ASSETS__LOADERS__IMAGE_EXR_H */